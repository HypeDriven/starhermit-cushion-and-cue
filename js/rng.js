/* Cushion & Cue — seeded random streams.
 * UMD: usable from the browser (window.CCRNG) and Node (require).
 * Independent streams are derived from one master seed so that rules,
 * decoration, AI, and audiovisual randomness never interfere.
 */
(function (root, factory) {
  if (typeof module === 'object' && module.exports) module.exports = factory();
  else root.CCRNG = factory();
